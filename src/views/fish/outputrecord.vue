<template>
  <div class="app-container">
    ...
    <el-table ref="dragTable" v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column min-width="140px" align="center" label="总数量">
        <template slot-scope="scope">
...
import { FetchOutputRecords, DeleteOutputRecord } from '@/api/fishpond'
...
export default {
  ...
  methods: {
    fetchList() {
      ...
      FetchOutputRecords(this.listQuery).then(response => {
    ...
    handleDelete(item) {
      ...
      this.$confirm('是否删除该条记录', '提示', {
        ...
        DeleteOutputRecord(data).then(response => {
          this.$notify({
            title: '已删除',
            type: 'success',
            message: '操作成功',
