<template>
  <div class="app-container">
    ...
    <el-table ref="dragTable" v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column min-width="100px" align="center" label="用户编码">
        <template slot-scope="scope">
    ...
    <el-dialog :visible.sync="detailVisible" :title="'编辑/查看设备详情'">
      <el-form :model="detailItem" label-width="180px" label-position="left">
        ...
        <el-form-item label="鱼塘名称">
          <el-input v-text="detailItem.controllerid" placeholder="鱼塘名称" />
        </el-form-item>
        <el-form-item label="用户编码">
          <el-input v-text="detailItem.controllerid" placeholder="用户编码" />
        </el-form-item>
        ...
        <el-form-item label="设备转速">
          <el-input v-text="detailItem.speed" :readonly="false" placeholder="设备转速（0-999之间的数）" />
        </el-form-item>
        <el-form-item label="设备功率">
          <el-input v-text="detailItem.gonglv" :readonly="false" placeholder="设备功率（0-9999之间的数）" />
        </el-form-item>
...
import { FetchDevices, DeleteDeviceById, EditDeviceInfo } from '@/api/fishpond'
...
export default {
  ...
  methods: {
    ...
    handleDelete(item) {
      console.log('删除 !!!!')
      this.$confirm('是否删除该条记录? 注：执行此操作，【设备分组】和【鱼塘中设备】中的该设备记录均会删除，请谨慎操作', '提示', {
